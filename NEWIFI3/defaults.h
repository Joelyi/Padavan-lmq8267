...
#define DEF_WLAN_2G_SSID	"Newifi3_%s"
#define DEF_WLAN_5G_SSID	"Newifi3_5G_%s"
#define DEF_WLAN_2G_GSSID	"Newifi3_GUEST_%s"
#define DEF_WLAN_5G_GSSID	"Newifi3_GUEST_5G_%s"
